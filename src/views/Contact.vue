      ...
      <div class="col-span-4 bg-gray-50 px-8 py-10 text-gray-800 md:col-span-2 md:border-r md:px-10 md:py-12 lg:col-span-1">
        ...
        <ul>
          <li class="mb-6 flex items-start text-left">
            ...
            <div>
              <a class="cursor-pointer font-serif text-base md:text-lg" href="#">dimasrizki275@gmail.com</a>
              <span class="block text-xs uppercase">email</span>
            </div>
          </li>
          <li class="my-6 flex items-center text-left">
            <img src="https://img.freepik.com/free-icon/twitter-social-logotype_318-65104.jpg?t=st=1692185772~exp=1692186372~hmac=d63bff01d84523ca907a801dd6e1867fafc17261991e333cf74ffe0b4698cb12" class="h-8 mr-3" alt="">
            <div>
              <a class="cursor-pointer font-serif text-base md:text-lg" href="https://twitter.com/diimsrzkii">Batman</a>
              <span class="block text-xs uppercase">twitter</span>
            </div>
          </li>
          <li class="my-6 flex items-center text-left">
            <img src="https://img.freepik.com/free-icon/instagram_318-566796.jpg?t=st=1692172409~exp=1692173009~hmac=43b353e86e4b3949a988ca8a8633616982293424d69a99f45f05ef7798f3b5d8" class="h-8 mr-3" alt="">
            <div>
              <a class="cursor-pointer font-serif text-base md:text-lg" href="https://msng.link/o?diimsrzki=ig">diimsrzki</a>
